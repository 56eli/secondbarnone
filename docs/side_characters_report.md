...
eager payload from ~4.85 MB to **~3.62 MB** while making the enlarged view
genuinely sharp.
...
| | Size | Limit |
|---|---|---|
| Eager (HTML/CSS/JS + thumbnails + backgrounds + compressed piano loop) | ~3.62 MB | 4 MB |
| Lightbox tier (on demand, ~80 KB per portrait opened) | ~4.36 MB | — |
| Total on disk | ~7.98 MB | 8 MB |
