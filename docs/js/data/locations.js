...
export const LOCATIONS = [
  ...
  loc({
    ...
    actionDesc:
      'You descended into the cool earth with a pickaxe. The rhythm of the swing, the dust, the focus — the devotion itself became the prayer.',
 ...
 *
 * Every location in a slot is deliberately revealed in turn. A locked card
