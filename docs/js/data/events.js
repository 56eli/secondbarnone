...
export function buildEventPool() {
  return [
    ...
    ev('community_support', 'Community Support',
      'Community members offer their support and encouragement. Lakshay surfaces from the cellar to tell you the archive is at ninety-four percent capacity and that everyone is very glad you are here, in that order. You are reminded why you started this journey.',
    ...
    ev('spiritual_doubt', 'Spiritual Doubt',
      'Doubts creep into your meditation. The silence feels empty rather than full, and questions gnaw at your faith. Arian, who has clearly not been to bed, says the silence is where they wait for you, and does not clarify who.',
    ...
    ev('unexpected_tips', 'Unexpected Tips',
      'The bar was busy tonight. A group celebrating a birthday left generous tips, and Barret lets you keep Yume’s hand-drawn tip sign for the next shift.',
    ...
    ev('difficult_customer', 'Difficult Customer',
      'A difficult customer causes a scene over their drink. The confrontation takes a toll on your patience and spirit. Dorian watches the whole thing from his armchair without moving, and afterwards says only: I\u2019m old. I don\u2019t want to do anything.',
      Category.BAR, Rarity.STANDARD, -6, 0, WEIGHT_STANDARD, 'bar', { character: 'dorian' }),
    ev('regular_story', 'Regular Tells a Story',
      'Arian gets three drinks in and starts telling the one about the community\u2019s first winter — your story, told better than you tell it, with details you are almost certain he invented. The whole bar leans in. You laugh along and decide not to correct anything.',
      Category.BAR, Rarity.STANDARD, 6, 0, WEIGHT_STANDARD, 'bar', { character: 'arian' }),
